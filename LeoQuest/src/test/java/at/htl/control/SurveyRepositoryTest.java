...
class SurveyRepositoryTest {
    ...
    void persistASurvey() {
        ...
        Questionnaire questionnaire = new Questionnaire("Quest1", "TestQuestionnaire 1", teacher);
        Survey survey = new Survey("title", "descr","teacher",questionnaire, LocalDate.of(2022,3,2));
